...
const SearchBar = ({ limit = null, showViewMore = false }) => {
  ...
  const loadExams = async (query = "") => {
    ...
    try {
      ...
      let url = `https://filerepository-backend.onrender.com/api/exam/fetchExams?search=${query}`;
  ...
  return (
    <div className="bg-[#050608] text-white pt-10">
      {/* Emerald Style Search Input Section */}
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex justify-between items-center mb-10">
          ...
          <div className="flex bg-[#0a0c10] p-1.5 rounded-xl border border-white/5">
            <button className="p-2 bg-emerald-500/10 rounded-lg text-emerald-400">
              <LayoutGrid size={18}/>
            </button>
